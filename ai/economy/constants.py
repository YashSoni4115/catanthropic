...
STANDARD_RESOURCE_BASELINE_TILE_COUNTS = dict(STANDARD_RESOURCE_TILE_COUNTS)
...
SCARCITY_DEVIATION_CAP = 1.0
ABUNDANCE_DEVIATION_CAP = 1.0
RESOURCE_RATIO_SPREAD_CAP = 1.0
STRONG_NUMBER_TOKENS = frozenset({6, 8})

SCARCE_TAG_THRESHOLD = 0.6
ABUNDANT_TAG_THRESHOLD = 0.6
CONCENTRATED_TAG_THRESHOLD = 0.65
ROBBER_FRAGILE_STRENGTH_THRESHOLD = 1.0
ROBBER_FRAGILE_CONCENTRATION_THRESHOLD = 0.45
BALANCED_BOARD_THRESHOLD = 0.78
POLARIZED_BOARD_THRESHOLD = 0.55
